...
SECRET_KEY = 'django-insecure-9hp3aa!hent03m5_zn$593$*gk2zt#z*vf2thc&sv!!zi&p9e$'
...
"""
# este código e  para o mysql 
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'boxapp', # O nome do banco de dados MySQL que você criou
...
# Altere a configuração para o SQLite:
DATABASES = {
    'default': {
